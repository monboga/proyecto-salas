    ...
    <body>
        ...
        <section class="home">
            ...
            <div class="text container">
                <div class="col-lg-6">
                    <h1 class="text-primary h3">Catalogo de Usuarios/Agregar</h1>
                    <form action="Controlador">
                        id:<br> 
                        <input class="form-control" type="text" name="txtNombre" placeholder="Nombre:"><br>
                        <input class="form-control" type="text" name="txtUsuario" placeholder="Usuario:"><br>
                        <input class="form-control" type="text" name="txtPassword" placeholder="Password:"><br>
                        <input class="form-control" type="text" name="txtIdRol" placeholder="Rol:">
